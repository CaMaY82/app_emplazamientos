...
class MenuPrincipal(QMainWindow):
    def __init__(self):
        ...
        central_layout.addWidget(self.buscar_img, 0, 0, Qt.AlignCenter)
        ...
        central_layout.addWidget(self.editar_img, 0, 1, Qt.AlignCenter)
        ...
        central_layout.addWidget(self.nuevo_img, 0, 2, Qt.AlignCenter)
        ...
        central_layout.addWidget(self.dash_img, 0, 3, Qt.AlignCenter)
        ...
        central_layout.addWidget(self.salir_img, 0, 4, Qt.AlignCenter)
